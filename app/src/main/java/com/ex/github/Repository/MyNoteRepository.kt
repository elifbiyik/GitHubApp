...
class MyNoteRepository @Inject constructor(
    ...
    private val databaseReferenceNoteForRepository =
        database.getReference("Note/Favorite Repository")

    suspend fun getMyNote(
        loginUser: String,
        noteToFavUser: String,
        isUserOrRepo: String
    ): ArrayList<Note> {
                        ...
                        if (snapshot.exists()) {
                            for (i in snapshot.children) {
                                ...
                                val noteToUserOrRepository =
                                    i.child("noteToUserOrRepository").getValue(String::class.java)
